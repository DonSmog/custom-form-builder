...
export function DroppableSection({
  ...
  const getJustifyContentClasses = (
    justifyContent: FormSection["justifyContent"]
  ) => {
  ...
  const sectionContentClasses = `space-y-4 flex flex-col ${getAlignmentClasses(
    section.alignment
  )} ${getAlignItemsClasses(section.alignItems)} ${getJustifyContentClasses(
          ...
          <div className="flex items-center space-x-1 flex-wrap">
            {section.alignment && section.alignment !== "left" && (
              <Badge variant="outline" className="text-xs">
                {
                  alignmentOptions.find((a) => a.value === section.alignment)
                    ?.label
                }
              </Badge>
            )}
            {section.alignItems && section.alignItems !== "start" && (
              <Badge variant="outline" className="text-xs">
                AI:{" "}
                {
                  alignItemsOptions.find((a) => a.value === section.alignItems)
                    ?.label
                }
              </Badge>
            )}
              ...
              <Badge variant="outline" className="text-xs">
                JC:{" "}
                {
                  justifyContentOptions.find(
                    (j) => j.value === section.justifyContent
                  )?.label
                }
              </Badge>
            )}
