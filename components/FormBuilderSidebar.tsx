...
import { Plus, Trash2, Save, FileText, FolderPlus, Users, Layers, Undo, Redo } from "lucide-react"
...
interface FormBuilderSidebarProps {
  ...
  selectedElementData: { element: FormElement; groupId: string; sectionId: string } | null
  ...
  addElement: (type: FormElement["type"], groupId: string, sectionId: string) => void
  updateSection: (sectionId: string, updates: Partial<FormSection>) => void
  updateGroup: (groupId: string, sectionId: string, updates: Partial<FormGroup>) => void
  updateElement: (elementId: string, groupId: string, sectionId: string, updates: Partial<FormElement>) => void
  saveForm: () => void
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex space-x-2">
            <Button onClick={onShowSavedForms} className="flex-1 bg-transparent" variant="outline">
              <FileText className="w-4 h-4 mr-2" />
              Saved Forms
            </Button>
            <Button onClick={onCreateNewForm} className="flex-1 bg-transparent" variant="outline">
        ...
        {/* Add Section Button */}
        <div>
          <Button onClick={addSection} className="w-full bg-transparent" variant="outline">
        ...
        <div>
          ...
          {!selectedSection && form.sections.length > 0 && (
            <p className="text-xs text-gray-500 mt-1">Select a section to add groups to it</p>
          )}
        </div>
              ...
              <DraggableElementType
                ...
                onAddElement={() => {
                  ...
                  if (targetSectionId && !targetGroupId) {
                    const section = form.sections.find((s) => s.id === targetSectionId)
                  ...
                  if (targetGroupId && targetSectionId) {
                    addElement(elementType.type as FormElement["type"], targetGroupId, targetSectionId)
                  }
                }}
              />
            ))}
          </div>
          <p className="text-xs text-gray-500 mt-2">Drag elements to groups or click to add to selected group</p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateGroup(selectedGroup!, selectedGroupData.sectionId, { title: e.target.value })}
                />
              </div>
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    updateGroup(selectedGroup!, selectedGroupData.sectionId, { description: e.target.value })
                  }
        ...
        {selectedElementData && (
          <div>
            ...
            <div className="space-y-4">
              ...
              {selectedElementData.element.type !== "checkbox" && selectedElementData.element.type !== "file" && (
                <div>
              ...
              {selectedElementData.element.type === "file" && (
                <div className="space-y-4">
                  <div>
                    ...
                    <Select
                      value={selectedElementData.element.fileConfig?.accept || "all"}
                      onValueChange={(value) =>
                        updateElement(selectedElement!, selectedElementData.groupId, selectedElementData.sectionId, {
                          fileConfig: {
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      min="1"
                      max="100"
                      value={selectedElementData.element.fileConfig?.maxSize || 10}
                      onChange={(e) =>
                        updateElement(selectedElement!, selectedElementData.groupId, selectedElementData.sectionId, {
                          fileConfig: {
                            ...selectedElementData.element.fileConfig,
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      id="file-multiple"
                      checked={selectedElementData.element.fileConfig?.multiple || false}
                      onCheckedChange={(checked) =>
                        updateElement(selectedElement!, selectedElementData.groupId, selectedElementData.sectionId, {
                          fileConfig: { ...selectedElementData.element.fileConfig, multiple: checked },
                        })
                      }
                    />
              ...
              {selectedElementData.element.type === "textfield" && (
                <div className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      id="text-content"
                      value={selectedElementData.element.textConfig?.content || ""}
                      onChange={(e) =>
                        updateElement(selectedElement!, selectedElementData.groupId, selectedElementData.sectionId, {
                          textConfig: {
                  ...
                  <div>
                    ...
                    <Select
                      value={selectedElementData.element.textConfig?.fontSize || "base"}
                      onValueChange={(value) =>
                        updateElement(selectedElement!, selectedElementData.groupId, selectedElementData.sectionId, {
                          textConfig: {
                            ...selectedElementData.element.textConfig,
                            fontSize: value as FormElement["textConfig"]["fontSize"],
                          },
                        })
                      }
                    >
                  ...
                  <div>
                    ...
                    <Select
                      value={selectedElementData.element.textConfig?.fontWeight || "normal"}
                      onValueChange={(value) =>
                        updateElement(selectedElement!, selectedElementData.groupId, selectedElementData.sectionId, {
                          textConfig: {
                            ...selectedElementData.element.textConfig,
                            fontWeight: value as FormElement["textConfig"]["fontWeight"],
                          },
                        })
                      }
                    >
              ...
              {(selectedElementData.element.type === "select" ||
                ...
                <div>
                  <Label>Options</Label>
                  <div className="space-y-2">
                    {selectedElementData.element.options?.map((option, index) => (
                      <div key={index} className="flex items-center space-x-2">
                        <Input
                          value={option}
                          onChange={(e) => {
                            const newOptions = [...(selectedElementData.element.options || [])]
                        ...
                        <Button
                          ...
                          onClick={() => {
                            const newOptions = selectedElementData.element.options?.filter((_, i) => i !== index)
                            updateElement(
                              selectedElement!,
                              selectedElementData.groupId,
                              selectedElementData.sectionId,
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const newOptions = [
                          ...
                          `Option ${(selectedElementData.element.options?.length || 0) + 1}`,
                        ]
                        updateElement(selectedElement!, selectedElementData.groupId, selectedElementData.sectionId, {
                          options: newOptions,
                        })
